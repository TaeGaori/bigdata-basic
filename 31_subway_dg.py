...
def save_csv(data, filename):
    ...
    with open(filename, 'w', newline='', encoding='utf-8-sig') as f:
        writer = csv.DictWriter(f, fieldname=[0].keys())
